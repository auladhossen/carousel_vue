    ...
    images:[
        {
            ...
            url: "https://images.unsplash.com/photo-1682685797769-481b48222adf?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE2fHx8ZW58MHx8fHx8&auto=format&fit=crop&w=1024&q=60",
            name: 'image-01'
        },
        {
            ...
            url: "https://images.unsplash.com/photo-1682695794816-7b9da18ed470?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE2fHx8ZW58MHx8fHx8&auto=format&fit=crop&w=1024&q=60",
            name: 'image-02'
        },
        {
            ...
            url: "https://images.unsplash.com/photo-1682685797661-9e0c87f59c60?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDE2fHx8ZW58MHx8fHx8&auto=format&fit=crop&w=1024&q=60",
            name: 'image-03'
        },  
        {  
            ...
            url: "https://images.unsplash.com/photo-1688841534418-b2e6ca99985a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1024&q=60",
            name: 'image-05'
        },  
        {  
            ...
            url: "https://images.unsplash.com/photo-1688118935892-b40fbf3b5e69?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1024&q=80",
            name: 'image-06'
        },  
        {  
            ...
            url: "https://images.unsplash.com/photo-1688153453932-bf45fe9d5f2c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1024&q=80",
            name: 'image-07'
        },
        {
            ...
            url: "https://images.unsplash.com/photo-1688232543149-5602b136ba11?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1024&q=80",
            name: 'image-08'
        },
    ],
    currentIndex: 0,
...
<template>
    ...
    <div class="image-slider flex flex-col border">
        <section class="flex justify-center items-center overflow-hidden mt-5">
            <button class="button" @click="previous" @mouseenter="pauseAutoSlide" @mouseleave="resumeAutoSlide"><span class="material-symbols-outlined">chevron_left</span></button>
        
            <div class="relative h-full m-5 flex justify-center items-center slider-item">               
              <div class="image-container flex justify-center items-center relative overflow-hidden rounded-lg border-sm w-[80vh]">
                <img class="cursor-pointer w-full" :src="currentImage.url">
              </div>
              
              <div class="absolute bottom-0 my-4 font-medium text-xs text-slate-300">{{ currentImage.name }}</div>
            </div>
    
            <button class="button" @click="next" @mouseenter="pauseAutoSlide" @mouseleave="resumeAutoSlide"><span class="material-symbols-outlined">chevron_right</span></button>
        </section>
